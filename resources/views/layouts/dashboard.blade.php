...
<head>
    ...
    <link rel="shortcut icon" href="{{ secure_secure_asset('images/favico-64x64.png') }}" type="image/x-icon" />
    <link rel="icon" href="{{ secure_secure_asset('images/favico-64x64.png') }}" type="image/x-icon">

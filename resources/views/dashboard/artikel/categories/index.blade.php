    ...
    <div class="row">
      <div class="card col-lg-10 offset-lg-1 col-sm-12 col-xs-12 pl-0 pr-0">
        ...
        <div class="card-block">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                	<small>
			            <a href="{{ route('admin.category.edit', ['id' => $category->id])  }}" class="btn btn-default btn-md">
			            	<i class="fa fa-pencil" aria-hidden="true"></i>
			            </a>
			            <button role="button" class="btn btn-default btn-md btn-nobg" data-href="{{ route('admin.category.delete', ['id' => $category->id]) }}" data-toggle="modal" data-target="#konfirmasiHapus">
          ...
          <a href="{{ route('admin.category.add') }}"><button class="btn btn-primary">Add New Category</button></a>
        </div>
      </div>
      <br>
